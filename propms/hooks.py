...
jinja = {
    "methods": [
        ...
        "propms.website_media.render_responsive_image",
    ]
}
...
# Website assets are selected per route to keep marketing/gallery dependencies
# off lightweight routes such as /login.
update_website_context = ["propms.website_assets.update_website_context"]
...
website_generators = ["Property Instruction", "PropMS Service", "PropMS Area"]

before_request = ["propms.website_routes.redirect_m10_section_routes"]
...
after_migrate = "propms.website_theme_assets.prepare_v2_theme_assets"
        ...
        "filters": [
            [
                ...
                (
                    ...
                    "Sales Invoice-lease",
                    "Website Settings-propms_social_section",
                    "Website Settings-propms_x_url",
                    "Website Settings-propms_facebook_url",
                    "Website Settings-propms_instagram_url",
                    "Website Settings-propms_linkedin_url",
                    "Website Settings-propms_google_url",
                    "Website Theme-propms_branding_section",
                    "Website Theme-propms_secondary_color",
                    "Website Theme-propms_accent_color",
                    "Website Theme-propms_surface_color",
                    "Website Theme-propms_border_color",
                    "Website Theme-propms_card_hover_style",
                    "Website Theme-propms_managed_theme",
                ),
            ]
        ],
    },
...
doc_events = {
    ...
    "Web Page": {
        "validate": [
            "propms.website_components.validate_web_page_components",
            "propms.website_seo.validate_web_page_seo",
        ]
    },
    "File": {"on_update": "propms.website_media.enqueue_media_generation"},
    "Website Theme": {
        "on_update": "propms.website_theme_assets.normalize_generated_theme_asset"
    },
}
...
website_route_rules = [
    {"from_route": "/propms-v2-preview", "to_route": "propms_v2_preview"},
]
