...
The dynamic Property Instruction page needs to match the guest-facing behavior that already works on a live reference Builder page while remaining maintainable inside `propms`.

## Live Page Findings

Source inspected:

- `https://example.com/pages/10-Example-Street`
- saved HTML: `/tmp/reference-builder-page.html`
